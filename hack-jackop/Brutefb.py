            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/channel/UCPWw9wqDL0_1C7AtyVDwwrQ')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def informasi():
    ...
    for p in cok['data']:
        ...
        print '\x1b[1;91m[\xe2\x9c\x96] kagak ketemu cuk'
        raw_input('\n\x1b[1;91m[ \x1b[1;97mKembali \x1b[1;91m]')
        menu()
...
def menu_hack():
    ...
    try:
        ...
        print '\x1b[1;87m[!] Token tidak ditemukan'
        os.system('rm -rf login.txt')
        time.sleep(1)
        login()
